...
/** Rolls one of the 5 events and applies its immediate setup (Rift Shop offers, Paradox Mirror's spawn). */
...
/** Event 5: one click of "Mine" inside the Rift modal — entirely self-contained, no map presence.
